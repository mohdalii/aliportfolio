...
const TECH_STAT = STATS.find((s) => s.label === 'Technologies');
...
const ABOUT_CARDS = [
  ...
  },
  {
    icon: Lightbulb,
    title: 'Skills',
    body: `Full stack development, machine learning, and generative AI across ${TECH_STAT?.value ?? ''}${TECH_STAT?.suffix ?? ''} technologies.`,
